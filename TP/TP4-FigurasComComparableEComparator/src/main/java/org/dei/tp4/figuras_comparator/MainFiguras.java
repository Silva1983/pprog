...
package org.dei.tp4.figuras_comparator;
// definir os critérios de comparação
import java.util.ArrayList;
import java.util.Collections;
import java.util.Comparator;
import java.util.List;
// usar o Comparator com classes anónimas
public class MainFiguras {
    ...
    public static void main(String[] args) {
        ...
        // subclasse (classe anónima) dentro da MainFiguras
        ...
        // ordenar por cor
        System.out.println("\n\t# Figuras por Ordem Alfabética da Cor #");
        Comparator<Figura> criterio3 = new Comparator<Figura>() {

            @Override
            public int compare(Figura f1, Figura f2) {
                return f1.getCor().compareTo(f2.getCor());
            }
        };
        listarForEach(figuras);
    }
