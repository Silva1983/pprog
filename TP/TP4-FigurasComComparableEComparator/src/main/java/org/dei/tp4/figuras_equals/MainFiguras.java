...
// defenir regras de 2 objectos - podem partilhar mais que 1 atributo - não precisam de ser todos iguais
...
public class MainFiguras {
    ...
    public static void main(String[] args) {
        ...
        Circulo c = new Circulo(); // à partida o objecto c está no 1º contentor do array
...
//        System.out.println(figuras.remove(null));
        ...
        // dá false pois a referência é diferente e no equals compara as referências
        // para dar true é necessário reescrever os parâmetros do equals na superclass e restantes
    }
