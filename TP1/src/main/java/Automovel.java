...
class Automovel {
    ...
    public Automovel(String matricula, String marca, int cilindrada) {
        this.matricula = matricula; // this. serve para diferenciar estes atributos
        this.marca = marca;
        this.cilindrada = cilindrada;
        totalAutomoveis++; // incrementador do atributo da classe
    }
    ...
    public int calcularDiferencaCilindrada(Automovel outroAutomovel) {
        return cilindrada - outroAutomovel.cilindrada; //o obj recebido como parâmetro é da classe que se está a implementar, senão não dava
        // Alternativa: 
