...
public abstract class AtletaNaoProfissional extends Atleta {
     ...
     * @param valorPremiosMensal - valor mensal dos prémios arrecadados pelo atleta
     * @param antiguidade - antiguidade no clube
     */
    public AtletaNaoProfissional(String nome, int numIdCivil, String genero,
            int idade, String atividade, int freqCardRepouso, float valorPremiosMensal, int antiguidade) {
        super(nome, numIdCivil, genero, idade, atividade, freqCardRepouso, valorPremiosMensal);
