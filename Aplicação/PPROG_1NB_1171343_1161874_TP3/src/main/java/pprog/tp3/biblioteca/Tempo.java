...
public class Tempo implements Comparable<Tempo> {
    ...
    public void setHoras(int horas) {
        if (horas < 0 || horas > 60) {
            throw new TempoInvalidoException("Hora inválida " + horas);
        }
        this.horas = horas;
    }
    ...
    public void setMinutos(int minutos) {
        if (horas < 0 || horas > 60) {
            throw new TempoInvalidoException("Minuto inválido " + horas);
        }
        this.minutos = minutos;
    }
    ...
    /**
     * Devolve o tempo no formato: %02d%02d.
     *
     * @return caraterísticas do tempo.
     */
     ...
     * se o outroTempo for posterior ao tempo; o valor 1 se o outroTempo for
     * anterior ao tempo.
     */
    @Override
     ...
     * @param segundos os outros segundos do tempo com o qual se compara o
     * tempo.
     ...
     * uma instãncia Tempo representativa da diferença entre o tempo e o tempo
     * recebido por parâmetro.
