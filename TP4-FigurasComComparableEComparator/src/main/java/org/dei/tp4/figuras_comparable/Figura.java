...
public abstract class Figura implements Comparable<Figura> {
    ...
    // como o atributo area é igual para todos, pode-se usar a superclasse para este método
    // este parâmetro é do tipo Figura, mas so fosse Object dava para qualquer tipo de objecto
    // daí estar <Figura> no "... implements Comparable..."
    @Override
